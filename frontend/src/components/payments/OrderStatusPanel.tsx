...
import { Truck, CheckCircle2, RotateCcw, Clock, Loader2, Link as LinkIcon, Plus, X, CalendarClock } from "lucide-react";
      ...
      <Dialog open={deliverOpen} onOpenChange={setDeliverOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Add links to the final files (Drive, GitHub, ZIP host, etc.) and a note for the client.</DialogDescription>
          </DialogHeader>
