...
import { initialsFromName, formatFundingCompact, formatCompactNumber, timeAgoOrDate } from "@/lib/utils";
import { renderBioHtml } from "@/lib/richText";
import { useAuth } from "@/context/AuthContext";
import type { FounderSummary } from "@/types";

const timeAgo = timeAgoOrDate;
    ...
    <div className="container space-y-6 py-10">
      ...
      <Card className="overflow-hidden">
        <CardContent className="p-6">
          ...
          {founder.bio && (
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-foreground/90" dangerouslySetInnerHTML={{ __html: renderBioHtml(founder.bio) }} />
          )}
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="p-5">
              ...
              {founder.bio && (
                <p className="text-sm leading-relaxed text-foreground/90" dangerouslySetInnerHTML={{ __html: renderBioHtml(founder.bio) }} />
              )}
