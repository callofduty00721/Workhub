...
const paymentSchema = new mongoose.Schema(
  {
    ...
    // Add-ons the buyer selected at gig-order time, snapshotted with the
    // price at the moment of purchase (never trust a client-submitted price —
    // see createGigOrderPayment, which looks these up from Service.extras).
    selectedExtras: [
      {
